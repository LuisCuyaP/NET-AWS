...
public class Function
{
    ...
    public async Task<SQSBatchResponse> FunctionHandler(SQSEvent sqsEvent, ILambdaContext context)
    {
        ...
        var useCase = scope.ServiceProvider.GetRequiredService<IProcessPeAppointmentService>();
        ...
        foreach (var record in sqsEvent.Records)
        {
            try
            {
                ...
                var message = JsonSerializer.Deserialize<ProcessPeAppointmentMessage>(record.Body, JsonOptions);
                if (message is null)
                {
