...
using Appointment.Pe.Infrastructure.AppointmentsAggregates;
using Appointment.Pe.Infrastructure.Messaging;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

namespace Appointment.Pe.Infrastructure;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var tableName = configuration["AWS:PeAppointmentsTableName"];
        ...
        services.AddScoped<IAppointmentPeRepository, AppointmentPeRepository>();
